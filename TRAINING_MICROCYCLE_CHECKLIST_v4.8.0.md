...
- [x] Plano recomendado aplicável ao Training Lab.
- [x] Avanço semanal processa microciclo antes do treino.
- [x] Exportação local JSON.
- [x] Sistemas anteriores preservados.
